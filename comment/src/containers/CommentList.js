...
class CommentListContainer extends Component {
    ...
    handleDeleteComment(index) {
        ...
        //props 是不能变的，所以这里新建了一个删除了特定下标的评论列表
        const newComments = [
            ...comments.slice(0, index),
            ...commnets.slice(index + 1)
        ]
...
const mapDispatchProps = (dispatch) => {
    return {
        ...
        // 当从 LocalStorage加载评论列表以后会通过这个方法
        //把评论列表初始化到 state当中
...
// 将 CommentListContainer connect 到 localStorage
